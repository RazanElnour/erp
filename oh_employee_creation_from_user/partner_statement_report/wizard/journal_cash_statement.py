...
class CustomerStatementPDF(models.TransientModel):
    _name = 'journal.cash.statement.pdf'

    from_date = fields.Date('From Date')
    to_date = fields.Date('To Date',)
    journal_id = fields.Many2one('account.journal', 'Cash', required=True,domain="[('type', '=', 'cash')]")
    ...
    def print_report(self):
        ...
        return self.env.ref('partner_statement_report.jornal_cash_statement_pdf_report_id').report_action([], data=data)
