...
class CustomerStatementReport(models.AbstractModel):
    _name = 'report.partner_statement_report.customer_statement_pdf_report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        docs = data['records']
        sales_details_report = self.env['ir.actions.report']._get_report_from_name('partner_statement_report.customer_statement_pdf_report')
        docargs = {
