odoo.define('is_accounting_samasu_13.account_report', function (require) {
'use strict';
    ...
    render_searchview_buttons: function() {
        ...
        if (this.report_options.partner) {
            if (!this.PM2MFilters) {
                ...
                if (!_.isEmpty(fields)) {
                    this.PM2MFilters = new M2MFilters(this, fields);
                    this.PM2MFilters.appendTo(this.$searchview_buttons.find('.js_account_partner_m2m'));

                }
            } else {
                this.$searchview_buttons.find('.js_account_partner_m2m').append(this.PM2MFilters.$el);
        ...
        if (this.report_options.analytic) {
            if (!this.AM2MFilters) {
                ...
                if (!_.isEmpty(fields)) {
                    this.AM2MFilters = new M2MFilters(this, fields);
                    this.AM2MFilters.appendTo(this.$searchview_buttons.find('.js_account_analytic_m2m'));
                }
            } else {
                this.$searchview_buttons.find('.js_account_analytic_m2m').append(this.AM2MFilters.$el);
            }
        }
    },
