...
class CustomerStatementReport(models.AbstractModel):
    _name = 'report.partner_statement_report.bank_statement_pdf_report'
    ...
    def _get_bank_statement(self, data):
        res = []
        if data['from_date'] and data['to_date']:
            ...
            print(move_line_ids,'move_line_ids1')
    ...
    def _get_report_values(self, docids, data=None):
        ...
        docs = data['records']
        sales_details_report = self.env['ir.actions.report']._get_report_from_name('partner_statement_report.bank_statement_pdf_report')
        docargs = {
        ...
        return {
            ...
            'get_bank_statement': self._get_bank_statement(data),
        }
