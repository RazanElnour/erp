...
class VendorStatementReport(models.AbstractModel):
    _name = 'report.is_penotee_accounting.vendor_statement_pdf_report'
                ...
                if customer_ids:
                    for customer_id in customer_ids:
                        ...
                        if move_line_ids:
                            ...
                            res.append({'debit': debit, 'credit': credit, 'balance': debit - credit,
    ...
    def _get_report_values(self, docids, data=None):
        ...
        docs = data['records']
        sales_details_report = self.env['ir.actions.report']._get_report_from_name('is_penotee_accounting.vendor_statement_pdf_report')
        docargs = {
